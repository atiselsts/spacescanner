...
from psutil_local import _psposix
from psutil_local._common import *
from psutil_local._compat import PY3, xrange, long, namedtuple, wraps
from psutil_local._error import AccessDenied, NoSuchProcess, TimeoutExpired
...
@deprecated('psutil_local.virtual_memory().cached')
def cached_phymem():
    return virtual_memory().cached


@deprecated('psutil_local.virtual_memory().buffers')
def phymem_buffers():
