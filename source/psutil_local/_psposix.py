...
from psutil_local._common import nt_diskinfo, usage_percent, memoize
from psutil_local._compat import PY3, unicode
from psutil_local._error import TimeoutExpired
