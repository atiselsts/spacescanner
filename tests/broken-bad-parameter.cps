      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Galazzo1990_FermentationPathwayKinetics,Vector=Reactions[NonexistentReaction],ParameterGroup=Parameters,Parameter=Vm8,Reference=Value"/>
